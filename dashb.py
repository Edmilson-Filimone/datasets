...
def info():
    ...
    expander.markdown('**Informacao**')
    expander.info("""- Para melhor exibicao
    ...
    expander.warning("""- No Telefone o dashboard pode 
                        ...
                        a opcao "vista para site de computador":   
    ...
    expander_2.info("""- Bio-Dashboard v.1.0 
                        ...
                        Correspondencia: philimone99@gmail.com""")
